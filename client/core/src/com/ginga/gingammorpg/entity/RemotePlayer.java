...
public class RemotePlayer extends Creature{
	...
	public RemotePlayer(float width, float height, String name, int ID, float x, float y, byte StartingRegion, int health, int maxHealth, int StyleID, World world, Skin skin, int level) {
